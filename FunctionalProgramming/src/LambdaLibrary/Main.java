...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * List<String> listStr = list.stream() .filter(cust ->
		 * cust.getCity().startsWith("Ma")) .map(cust -> cust.getName())
		 * .sorted() .collect(Collectors.toList()); System.out.println(listStr);
		 */

		/*
		 * Step 2: transform the pipeline into a named lambda expression and put
